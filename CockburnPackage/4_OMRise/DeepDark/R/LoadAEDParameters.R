...
kpart_denitrit<-as.numeric(aed.params[which(aed.params=="kpart_denitrit") ][,2]);kpart_denitrit
kpart_ammox   <-as.numeric(aed.params[which(aed.params=="kpart_ammox")    ][,2]);kpart_ammox
xlab          <-as.numeric(aed.params[which(aed.params=="xlab")           ][,2]);xlab
ylab          <-as.numeric(aed.params[which(aed.params=="ylab")           ][,2]);ylab
