  ...
  datafolder <-paste0("X:/Development/danp/AED_testing/Datafolder/")
  ...
  image.plot(time.s,bw.sed.depths,con.s.bw,cex.lab=0.001
             ...
             ,bigplot=c(0.16,0.85,0.12,0.78)# 1 left; 2 right; 3 bottom; 4 top
             ,smallplot=c(0.87,0.90,0.11,0.77)# 1 left; 2 right; 3 bottom; 4 top
             ,col=newglen(5000)
             ,xaxs = "i"
             ,graphics.reset = F
