...
linematrix.3 <- as.matrix(rowSums(linematrix[,2:length(extrafiles)]))
...
axis(2,cex.axis=0.7,cex.lab=axis.label.size,tck=T,tcl=-0.2,line=0,tck=T,tcl=-0.3,col.axis="white",at=y.axis.sequence)# Ticks
