...
This simulation folder is set up to run the Seagrass environment for five years of spin up and then five years of seasonal oscillations, then one year that includes a month of oxygen drop in the bottom water. 
