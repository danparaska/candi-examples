# dailyfluxlabels<-function(thisfile){
  ...
  if(thisfile=="caco3")     {label.bold.nounit=expression(bold("CaCO"[3]))}
  if(thisfile=="ca")        {label.bold.nounit=expression(bold("Ca"^"2+"))}
  ...
  if(thisfile=="feco3")     {label.bold.nounit=expression(bold("FeCO"["3"]))}
  ...
  if(thisfile=="dopr")      {label.bold.nounit=expression(bold("Refractory DOP"))}
  if(thisfile=="MPB")       {label.bold.nounit=expression(bold("MPB"))}
  ...
  if(thisfile=="salinity")  {label.bold.nounit=expression(bold("Salinity"))}
  if(thisfile=="bioturb")   {label.bold.nounit=expression(bold("bioturbation"))}
  if(thisfile=="cirrig")  {label.bold.nounit=expression(bold("irrigation"))}
  # label<<-label
# }
