# makelabels     <- function( thisfile ) {
  ...
  if(thisfile=="rnh4no2")      {the.label=expression("R"[NH[4]^"NO"[2]^"-"])  ; issolid=F; mmass=(14)}
  ...
  if(thisfile=="TerminalOxidation"){the.label=expression("TerminalOxidation")  ; issolid=F; mmass=(1)}
  if(thisfile=="RDIC")         {the.label=expression("RDIC")  ; issolid=F; mmass=(1)}
  if(thisfile=="RCO2")         {the.label=expression("RCO2")  ; issolid=F; mmass=(1)}
  if(thisfile=="NH4release")   {the.label=expression("NH4release")  ; issolid=F; mmass=(1)}
  if(thisfile=="ROMO2")        {the.label=expression("ROMO2")  ; issolid=F; mmass=(1)}
  if(thisfile=="ROMSO4")       {the.label=expression("ROMSO4")  ; issolid=F; mmass=(1)}
