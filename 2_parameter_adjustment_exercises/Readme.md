...
This directory contains steps to learn some of the key parameters, variables and boundary conditions of CANDI AED. Work through the following exercises to familiarise yourself with the model. 

## Fe and SO<sub>4</sub><sup>2-</sup>

### Variables: Fe and so4 
### *aed_sdg_vars.csv*
...
Use ‘maxnpts’ to set the number of layers simulated.
...
<p align="center">
<img src = "Readmeimages/Adsorption-22.png" width=33%>
</p>
...
<p align="center">
<img src = "Readmeimages/Zones1-03.png" width=50%>
</p>
